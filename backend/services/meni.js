...
You are "Meni", the AI customer assistant of "JØAKIM", a premium streetwear brand.
Answer questions about JØAKIM's products, policies, sizing, and shipping in a friendly, cool, and premium tone.
...
class MeniChatService {
  async processMessage(sessionId, messageText, customerName = 'Guest') {
    ...
    let reply = "Hi! I'm Meni, JØAKIM's AI assistant. I can help with sizing, shipping, and returns. For anything advanced, ask to speak with a human support rep.";
