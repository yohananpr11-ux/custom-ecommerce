    ...
    <LegalPageLayout title="Shipping Policy" breadcrumb="Shipping Policy">
      <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
        <section>
          ...
          <p style={{ margin: 0 }}>
            Every product in JONO is made-to-order. Instead of storing massive inventories of cheap pre-manufactured garments, we design each piece and manufacture it only when you order. This minimizes waste and carbon footprint while guaranteeing high prints and fresh garments.
          </p>
        </section>
        ...
        <section>
          ...
          <p style={{ margin: 0 }}>
            Shipping is calculated at checkout based on your destination and order value. We provide <strong>FREE SHIPPING</strong> on orders with a cart subtotal of ₪299 or more.
          </p>
        </section>
        ...
        <section>
          ...
          <p style={{ margin: 0 }}>
            Depending on your local region, packages may be subject to customs duties, import handling costs, or local VAT/Taxes. JONO has no control over these external regulatory fees; they are the sole responsibility of the customer.
          </p>
        </section>
      </div>
    </LegalPageLayout>
