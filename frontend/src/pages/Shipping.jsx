    ...
    <LegalPageLayout title="Shipping Policy" breadcrumb="Shipping">
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        <section style={sectionStyle}>
          ...
          <p dir="rtl" style={{ margin: 0, lineHeight: 1.9 }}>ב-JØAKIM אנו שואפים לספק חוויית משלוח חלקה, שקופה ואמינה. הזמנות עוברות עיבוד, אריזה ושילוח בהתאם לזמינות המלאי וליעד המסירה.</p>
        </section>
