      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }}>
        ...
        <section style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <p style={{ margin: 0, fontSize: '18px', lineHeight: '1.7', color: 'var(--color-white)', opacity: 0.95 }}>
            JONO is a minimalist streetwear label born out of the desire to combine high-end aesthetic tailoring with maximum daily comfort. We believe that confidence starts with how you feel in what you wear.
          </p>
          <p style={{ margin: 0 }}>
