      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        <section style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)', padding: '24px', borderRadius: '8px', border: '1px solid var(--border-color)' }}>
          ...
          <p dir="rtl" style={{ margin: 0, fontSize: '14px', lineHeight: '1.8' }}>
            מוצרי JOAKIM מיוצרים לפי הזמנה, ולכן לא ניתן להחזיר או להחליף פריטים בגלל בחירת מידה שגויה או שינוי דעת. עם זאת, אנחנו מעניקים אחריות של 30 יום במקרה של פגם ייצור, הדפסה לא תקינה או נזק שנגרם במשלוח.
          </p>
        </section>
